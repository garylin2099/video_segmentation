...
class LRR:
    ...
    def get_blobs(self, im, dropout_keeprate=1):
        ...
        im = im - np.array([80.0, 100.0, 80.0])
        ...
        blobs['prediction_4x_add'] = tf.concat([tf.nn.conv2d_transpose(tf.slice(blobs['coef_4x'], [0, 0, 0, 10*k], [-1, -1, -1, 10]), tf.slice(self.weights['deconv_4xf'], [0, 0, 0, 10*k], [-1, -1, -1, 10]), output_shape=[batch_size, ADAPTED_HEIGHT, ADAPTED_WIDTH, 1], strides=[1,4,4,1]) for k in range(7)], axis=3)


        blobs['prediction_8x_bil_x2'] = tf.concat([tf.nn.conv2d_transpose(tf.slice(blobs['prediction_8x'], [0, 0, 0, k], [-1, -1, -1, 1]), tf.slice(self.weights['dec_prediction_8x_bil_x2f'], [0, 0, 0, k], [-1, -1, -1, 1]), output_shape=[batch_size, ADAPTED_HEIGHT, ADAPTED_WIDTH, 1], strides=[1,2,2,1]) for k in range(7)], axis=3)
    ...
    def all_variables(self):
        return [('deconv_16xf', (8, 8, 1, 70)),
            ('conv3_1b', (256,)), 
            ('bases_coef_32xb', (70,)),
            ('dil_seg32x_coeff', (5, 5, 4096, 70)),
            ...
            ('bases_coef_16xb', (70,)),
            ('dil_seg32x_coefb', (70,)),
            ('deconv_32xf', (8, 8, 1, 70)),
            ('bases_coef_16sf', (5, 5, 512, 70)),
            ('ero_mask32s_coeff', (5, 5, 4096, 70)),
            ('conv4_1b', (512,)), 
            ('bases_coef_32xf', (5, 5, 4096, 70)),
            ('conv2_2b', (128,)), 
            ('conv1_2b', (64,)),  
            ('conv3_3f', (3, 3, 256, 256)),
            ('dec_prediction_8x_bil_x2f', (4, 4, 1, 7)),
            ('conv3_2b', (256,)), 
            ('bases_coef_8xb', (70,)),
            ('fc7f', (1, 1, 4096, 4096)),
            ('ero_seg_deconv_32xf', (8, 8, 1, 70)),
            ('conv2_1b', (128,)), 
            ('conv1_2f', (3, 3, 64, 64)),
            ('fc6b', (4096,)),
            ('conv4_2b', (512,)), 
            ('ero_seg32x_coefb', (70,)),
            ('bases_coef_8xf', (5, 5, 512, 70)),
            ('conv5_2f', (3, 3, 512, 512)),
            ('conv1_1b', (64,)),  
            ('conv5_1f', (3, 3, 512, 512)),
            ('bases_coef_4xb', (70,)),
            ('conv3_1f', (3, 3, 128, 256)),
            ('dec_prediction_16x_bil_x2f', (4, 4, 1, 7)),
            ('conv3_3b', (256,)), 
            ('conv2_1f', (3, 3, 64, 128)),
            ('deconv_4xf', (8, 8, 1, 70)),
            ('dil_mask_deconv32sb', (7,)),
            ('conv5_3b', (512,)), 
            ('fc7b', (4096,)),
            ('conv2_2f', (3, 3, 128, 128)),
            ('conv4_3b', (512,)), 
            ('conv5_1b', (512,)), 
            ('bases_coef_4xf', (5, 5, 256, 70)),
            ('conv4_1f', (3, 3, 256, 512)),
            ('dec_prediction_32x_bil_x2f', (4, 4, 1, 7)),
            ('deconv_8xf', (8, 8, 1, 70)),
            ('conv1_1f', (3, 3, 3, 64)),
            ('dil_seg_deconv_32xf', (8, 8, 1, 70)),
            ('ero_mask_deconv32sb', (7,))]