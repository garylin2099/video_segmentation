...
cityscapes_dir = '/home/yizhang/cityscape/gt'

# Where "leftImg8bit_sequence_trainvaltest.zip" is unpacked. May be the same path as above.
cityscapes_video_dir = '/home/yizhang/cityscape/left'

# Where "https://github.com/mcordts/cityscapesScripts" is unpacked
cityscapes_scripts_root = os.path.join(cityscapes_dir, 'cityscapesscripts')
...
example_im = os.path.join(cityscapes_video_dir, 'leftImg8bit', 'train', 'jena', 'jena_000000_000019_leftImg8bit.png')
